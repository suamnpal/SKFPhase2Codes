...
{
    public class Dummy_HYLSOR_Avdragshylsor_60_1060_MacTurn_550_VTR_160_V21 : ITemplateCalculations
    {
        ...
        public Dictionary<string, string> CalculateWordParameters(APIRequest req)
        {
            ...
            kv["SumV"] = Math.Abs(tmpKona - 30) < 0.0001 ? "0º57" : "2º23";
            ...
            kv["SumP"] = "(P) " + (tmpRitAHA ? "6,0" : FormatSimple(tmpStmm));
            ...
            kv["SumGänga"] = !tmpRitAHA ? (((Math.Abs(tmpStmm - 1) < 0.0001) || (Math.Abs(tmpStmm - 1.5) < 0.0001) || (Math.Abs(tmpStmm - 2) < 0.0001) || (Math.Abs(tmpStmm - 3) < 0.0001)) ? "M " + FormatSimple(tmpd2) + "x " + FormatSimple(tmpStmm) : "Tr " + FormatSimple(tmpd2) + "x " + FormatSimple(tmpStmm)) : "11,004x6UN";
            ...
            kv["SumHmTol"] = "+ " + FormatF3(tmpb2Tol);
            kv["SumHmTolN"] = "- " + FormatF3(tmpb2Tol + tmpLTolN);
            ...
            kv["SumAF1_1"] = "";
            kv["SumAF1_2"] = machineMatch ? "Rullar: " + kv["SumRullar"] + ", inställd med klove" : "";
            kv["SumAF1_3"] = "";
            kv["SumAF1_4"] = "";
            kv["SumAF1_5"] = "";
            kv["SumAF1_6"] = "";
            ...
            kv["SumAF2_7"] = machineMatch ? "Tolerans: " + kv["SumKonavv"] : "";
            kv["SumAF2_8"] = machineMatch ? "Max variation: " + FormatF3(tmpKr) : "";
