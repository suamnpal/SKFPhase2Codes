...
{
    public class TATNINGAR_SL_TSO_200_1 : ITemplateCalculations
    {
        ...
        public Dictionary<string, string> CalculateWordParameters(APIRequest req)
        {
            ...
            object tmpBet3 = IsNumeric(tmpBet3a) && tmpBet3a != "0" ? ParseDouble(tmpBet3a) : (object)tmpBet3a;
            object tmpBet4 = IsNumeric(tmpBet4a) && tmpBet4a != "0" ? ParseDouble(tmpBet4a) : (object)tmpBet4a;
            object tmpBet5 = IsNumeric(tmpBet5a) ? ParseDouble(tmpBet5a) : (object)tmpBet5a;
            object tmpBet6 = IsNumeric(tmpBet6a) ? ParseDouble(tmpBet6a) : (object)tmpBet6a;
            object tmpBet7 = IsNumeric(tmpBet7a) ? ParseDouble(tmpBet7a) : (object)tmpBet7a;
            ...
            double tmpTumMm = tmpTum ? Math.Round((tmpBet4Number * 25.4) + (tmpBet6Number == 0 ? 0 : (tmpBet5Number / tmpBet6Number) * 25.4), 2) : 0;

            bool variant1 = tmpBet4Number == 1 || tmpBet7Number == 1;
            bool variant2 = tmpBet4Number == 2 || tmpBet7Number == 2;

            string tmpV21ListaD13 = variant1 && tmpSerie == "5" && tmpTyp == 40 ? "{214:234:246}" : "";

            string tmpStandardListaD13 = tmpTyp == 17 ? "{90:98:108}" : tmpTyp == 18 ? "{95:103:113}" : tmpTyp == 20 ? "{107:115:125}" : tmpTyp == 22 ? "{118:126:136}" : tmpTyp == 24 ? "{128:139:149}" : tmpTyp == 26 ? "{138:149:159}" : tmpTyp == 28 ? "{150:160:170}" : tmpTyp == 30 ? "{160:175:187}" : tmpTyp == 32 ? "{170:187:199}" : tmpTyp == 34 ? "{182:200:212}" : tmpTyp == 36 ? "{192:209:221}" : tmpTyp == 38 ? "{202:220:232}" : tmpTyp == 40 ? "{214:234:246}" : tmpTyp == 44 ? "{233:255:267}" : tmpTyp == 48 ? "{255:280:292}" : "{0:0:0}";

            string tmpVariant2ListaD13 = tmpTyp == 17 ? "{88:x:120}" : tmpTyp == 18 ? "{92:x:128}" : tmpTyp == 20 ? "{102:x:142}" : tmpTyp == 22 ? "{112:x:152}" : tmpTyp == 24 ? "{125:139:168}" : tmpTyp == 26 ? "{135:149:175}" : tmpTyp == 28 ? "{145:x:200}" : tmpTyp == 30 ? "{155:x:210}" : tmpTyp == 32 ? "{165:x:225}" : tmpTyp == 34 ? "{175:200:234}" : tmpTyp == 36 ? "{185:209:250}" : tmpTyp == 38 ? "{195:220:270}" : tmpTyp == 40 ? "{205:x:280}" : tmpTyp == 44 ? "{224:x:305}" : tmpTyp == 48 ? "{250:x:325}" : "{0:0:0}";

            string tmpListaD13 = tmpV21 ? tmpV21ListaD13 : (variant1 || tmpSerie == "2") ? tmpStandardListaD13 : variant2 ? tmpVariant2ListaD13 : "";

            string tmpV21ListaD46 = variant1 && tmpSerie == "5" && tmpTyp == 40 ? "{297:244:274}" : "";

            string tmpStandardListaD46 = tmpTyp == 17 ? "{120:96:110}" : tmpTyp == 18 ? "{128:100:114}" : tmpTyp == 20 ? "{142:112:127}" : tmpTyp == 22 ? "{152:120:137}" : tmpTyp == 24 ? "{168:135:154}" : tmpTyp == 26 ? "{175:145:162}" : tmpTyp == 28 ? "{200:160:182}" : tmpTyp == 30 ? "{210:170:190}" : tmpTyp == 32 ? "{225:178:202}" : tmpTyp == 34 ? "{234:195:216}" : tmpTyp == 36 ? "{250:205:230}" : tmpTyp == 38 ? "{270:220:247}" : tmpTyp == 40 ? "{280:227:257}" : tmpTyp == 44 ? "{305:255:285}" : tmpTyp == 48 ? "{325:270:300}" : "{0:0:0}";

            string tmpListaD46 = tmpV21 ? tmpV21ListaD46 : tmpStandardListaD46;

            double tmpd = tmpTum ? tmpTumMm : (tmpTyp * 10) / 2;

            kv["SumD"] = "(d) " + Smart(tmpd);
            kv["Sumda"] = Smart(tmpd);
            kv["SumDTol"] = tmpd < 80.1 ? "+ 0.060" : tmpd < 120.1 ? "+ 0.071" : tmpd < 180.1 ? "+ 0.083" : tmpd < 250.1 ? "+ 0.096" : tmpd < 315.1 ? "+ 0.108" : tmpd < 400.1 ? "+ 0.119" : "+ 0.131";
            kv["SumDTolN"] = tmpd < 80.1 ? "+ 0.030" : tmpd < 120.1 ? "+ 0.036" : tmpd < 180.1 ? "+ 0.043" : tmpd < 250.1 ? "+ 0.050" : tmpd < 315.1 ? "+ 0.056" : tmpd < 400.1 ? "+ 0.062" : tmpd < 500.1 ? "+ 0.068" : "+ 0.076";
            ...
            string[] tmpaLista = tmpVZ2A6 ? new[] { "t17", "t18", "t20", "t22", "100", "95", "t28", "t30", "106", "t34", "t36", "t38", "t40", "t44", "t48" } : (variant1 || tmpSerie == "2") ? new[] { "72", "75", "80", "88", "109", "103", "106", "103,5", "118", "132", "137", "139", "140", "148", "150" } : new[] { "52,5", "55,5", "58,5", "66", "87", "80", "82", "77,5", "90", "103,5", "107", "108", "108", "113", "113" };
            ...
            string[] tmpbLista = variant1 ? new[] { "52", "55", "56", "60", "75", "71", "74", "73,5", "84", "91,5", "96,5", "98,5", "99,5", "108", "110" } : tmpSerie == "2" && tmpBet4Number == 2 ? new[] { "54", "57", "60", "66", "80", "74", "81", "77", "89", "95", "100", "102", "110", "111", "117" } : new[] { "x", "x", "x", "x", "80", "74", "x", "x", "x", "95", "98,5", "99,5", "x", "x", "x" };
            ...
            string[] tmpcLista = variant1 ? new[] { "49", "52", "53", "57", "72", "67", "70", "68,5", "80", "87", "92", "94", "95", "101", "103" } : new[] { "49", "52", "54", "60", "72", "67", "70", "68,5", "81", "87", "92", "94", "96", "101", "104" };
            ...
            string[] tmpeLista = tmpSerie == "5" && variant2 ? new[] { "36", "39", "37", "37,5", "47,5", "44", "47", "46,5", "55", "58", "63", "65", "65,5", "71,5", "74" } : new[] { "36", "39", "38,5", "38,5", "47,5", "44", "47", "46,5", "55,5", "58", "63", "65", "66", "71,5", "74" };
            ...
            string[] tmpfLista = variant1 ? new[] { "12", "10", "8", "8", "11", "8", "11", "16", "15", "15", "23", "25", "25", "25", "20" } : new[] { "3", "4", "4", "6", "5", "5", "5", "5", "5", "8", "10", "10", "7", "5", "8" };
            ...
            string tmpp = variant1 ? (tmpTyp < 33 ? "10,5" : "13") : "x";

            kv["Sump"] = tmpp == "x" ? "" : "(p) " + tmpp;
            kv["SumpTol"] = tmpp == "x" ? "" : "+ 0.2";
            kv["SumpTolN"] = tmpp == "x" ? "" : "- 0";

            string tmpr = variant1 ? (tmpTyp < 33 ? "6" : "15") : "x";
            ...
            kv["SumRit"] = tmpVZ2A6 ? "7439472" : tmpSlash ? (tmpBet7Number == 1 ? "7439269" : "7439270") : (tmpBet4Number == 1 ? "7438712" : "7438713");
