...
{
    public class MUTTRAR_HME_30_31_44_1060_SPECIAL_OP1_3 : ITemplateCalculations
    {
        ...
        public Dictionary<string, string> CalculateWordParameters(APIRequest req)
        {
            ...
            bool tmpV = tmpBet.Split(new char[] { ' ', '/', '.', '-' }, StringSplitOptions.RemoveEmptyEntries).Length > 3 &&
                            tmpBet.Split(new char[] { ' ', '/', '.', '-' }, StringSplitOptions.RemoveEmptyEntries)[3].IndexOf('V') >= 0;
            ...
            string tmpTypStr = cntB2 > 3 ? RightSafe(tmpBet2, 2) : tmpBet3;
        ...
        private static double T5_30(double typ) { if (typ < 84) return 0.84; if (typ < 750) return 1.00; return 1.20; }
        private static double T5_31(double typ) { if (typ < 76) return 0.84; if (typ < 710) return 1.00; return 1.20; }
        private static double T7_30(double typ) { if (typ < 84) return 1.3; if (typ < 750) return 1.6; return 1.9; }
        private static double T7_31(double typ) { if (typ < 76) return 1.3; if (typ < 710) return 1.6; return 1.9; }
