...
{
    public class TATNINGAR_SL_TSO_500_1_V22 : ITemplateCalculations
    {
        ...
        public Dictionary<string, string> CalculateWordParameters(APIRequest req)
        {
            ...
            string tmpBet7b = string.IsNullOrEmpty(tmpBet7a) ? "0" : tmpBet7a;
            ...
            object tmpBet5 = IsNumeric(tmpBet5b) ? ParseDouble(tmpBet5a) : (object)tmpBet5a;
            object tmpBet6 = IsNumeric(tmpBet6b) ? ParseDouble(tmpBet6a) : (object)tmpBet6a;
            object tmpBet7 = IsNumeric(tmpBet7b) ? ParseDouble(tmpBet7a) : (object)tmpBet7a;
            ...
            if (tmpTypLista < 1)
                throw new InvalidOperationException("TmpTyp '" + Smart(tmpTyp) + "' finns inte i TmpTypLista. Subject: " + subject);
            ...
            double tmpTumMm = tmpTum && tmpBet6Number != 0 ? Math.Round((tmpBet4Number * 25.4) + ((tmpBet5Number / tmpBet6Number) * 25.4), 2) : 0;

            string tmpV22ListaD13 = tmpTyp == 32 ? "{173:187:199}" : "";

            string tmpListaD13 = tmpV22 ? tmpV22ListaD13 : tmpTyp == 17 ? "{90:98:108}" : tmpTyp == 18 ? "{95:103:113}"
                : tmpTyp == 20 ? "{107:115:125}" : tmpTyp == 22 ? "{118:126:136}" : tmpTyp == 24 ? "{128:139:149}"
                : tmpTyp == 26 ? "{138:149:159}" : tmpTyp == 28 ? "{150:160:170}" : tmpTyp == 30 ? "{160:175:187}"
                : tmpTyp == 32 ? "{170:187:199}" : tmpTyp == 34 ? "{182:200:212}" : tmpTyp == 36 ? "{192:209:221}"
                : tmpTyp == 38 ? "{202:220:232}" : tmpTyp == 40 ? "{214:234:246}" : tmpTyp == 44 ? "{233:255:267}"
                : tmpTyp == 48 ? "{255:280:292}" :"{0:0:0}";

            string tmpListaD46 = tmpTyp == 17 ? "{120:96:110}"
                : tmpTyp == 18 ? "{128:100:114}"
                : tmpTyp == 20 ? "{142:112:127}"
                : tmpTyp == 22 ? "{152:120:137}"
                : tmpTyp == 24 ? "{168:135:154}"
                : tmpTyp == 26 ? "{175:145:162}"
                : tmpTyp == 28 ? "{200:160:182}"
                : tmpTyp == 30 ? "{210:170:190}"
                : tmpTyp == 32 ? "{225:178:202}"
                : tmpTyp == 34 ? "{234:195:216}"
                : tmpTyp == 36 ? "{250:205:230}"
                : tmpTyp == 38 ? "{270:220:247}"
                : tmpTyp == 40 ? "{280:227:257}"
                : tmpTyp == 44 ? "{305:255:285}"
                : tmpTyp == 48 ? "{325:270:300}"
                : "{0:0:0}";

            double tmpd = tmpTum ? tmpTumMm : tmpTyp < 25 ? ((tmpTyp * 10) / 2) - 10 : tmpTyp < 31 ? ((tmpTyp * 10) / 2) - 15 : ((tmpTyp * 10) / 2) - 20;
            bool serie2Variant1 = tmpBet4Number == 1 && tmpSerie == "2";

            kv["SumD"] = "(d) " + Smart(tmpd);
            kv["Sumda"] = Smart(tmpd);
            kv["SumDTol"] = serie2Variant1 ? (tmpd < 80.1 ? "+ 0.060" : tmpd < 120.1 ? "+ 0.071" : tmpd < 180.1 ? "+ 0.083" : tmpd < 250.1 ? "+ 0.096" : tmpd < 315.1 ? "+ 0.108" : tmpd < 400.1 ? "+ 0.119" : "+ 0.131") : (tmpd < 50.1 ? "+ 0.025" : tmpd < 80.1 ? "+ 0.030" : tmpd < 120.1 ? "+ 0.035" : tmpd < 180.1 ? "+ 0.040" : tmpd < 250.1 ? "+ 0.046" : tmpd < 315.1 ? "+ 0.052" : tmpd < 400.1 ? "+ 0.057" : "+ 0.063");
            kv["SumDTolN"] = serie2Variant1 ? (tmpd < 80.1 ? "+ 0.030" : tmpd < 120.1 ? "+ 0.036" : tmpd < 180.1 ? "+ 0.043" : tmpd < 250.1 ? "+ 0.050" : tmpd < 315.1 ? "+ 0.056" : tmpd < 400.1 ? "+ 0.062" : tmpd < 500.1 ? "+ 0.068" : "+ 0.076") : "+ 0";
            ...
            string[] tmpaLista = tmpV22 ? new[] { "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "106", "p10", "p11", "p12", "p13", "p14", "p15" }
                : new[] { "72", "75", "80", "88", "109", "103", "106", "103,5", "118", "132", "137", "139", "140", "148", "150" };
            ...
            string[] tmpbLista = { "52", "55", "56", "60", "75", "71", "74", "73,5", "84", "91,5", "96,5", "98,5", "99,5", "108", "110" };
            ...
            string[] tmpcLista = variant1 ? new[] { "49", "52", "53", "57", "72", "67", "70", "68,5", "80", "87", "92", "94", "95", "101", "103" }
                : new[] { "49", "52", "54", "60", "72", "67", "70", "68,5", "81", "87", "92", "94", "96", "101", "104" };
            ...
            bool serie5Variant2 = tmpSerie == "5" && (tmpBet7Number == 2 || tmpBet4Number == 2);

            string[] tmpeLista = serie5Variant2 ? new[] { "36", "39", "37", "37,5", "47,5", "44", "47", "46,5", "55", "58", "63", "65", "65,5", "71,5", "74" }
                : new[] { "36", "39", "38,5", "38,5", "47,5", "44", "47", "46,5", "55,5", "58", "63", "65", "66", "71,5", "74" };
            ...
            string[] tmpfLista = variant1 ? new[] { "12", "10", "8", "8", "11", "8", "11", "16", "15", "15", "23", "25", "25", "25", "20" }
                : new[] { "3", "4", "4", "6", "5", "5", "5", "5", "5", "8", "10", "10", "7", "5", "8" };
        ...
        private static double ParseDouble(string value) => string.IsNullOrWhiteSpace(value)  ? 0
            : double.TryParse(value.Replace(",", "."), NumberStyles.Any, CultureInfo.InvariantCulture, out double result)  ? result : 0;
        ...
        private static string GetArrayItem(string[] values, int lotusPosition) =>
